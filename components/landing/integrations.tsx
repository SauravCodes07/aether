...
const integrationsList = [
  {
    ...
    status: "ready",
    icon: (
      <svg className="h-6 w-6 text-white transition-transform group-hover:rotate-45 duration-500" viewBox="0 0 24 24" fill="currentColor">
      ...
      <Container>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {integrationsList.map((integration) => {
            ...
            return (
              <Card key={integration.id} hover className="group flex flex-col justify-between">
                <div>
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-aether-border bg-aether-bg-elevated">
                    {integration.icon}
                  </div>
                  <div className="mb-3 flex items-center justify-between">
                    <h3 className="font-semibold text-aether-text group-hover:text-aether-accent-light transition-colors">
                      {integration.name}
                    </h3>
